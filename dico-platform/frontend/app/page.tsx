...
const mockProjects: Project[] = [
  {
    ...
    description:
      "A revolutionary decentralized finance protocol that enables users to earn yield through automated strategies.",
    logo: "💰",
      ...
      milestones: [
        {
          ...
          reached: true,
          reachedAt: new Date("2024-02-01"),
        },
        {
          id: "2",
          percentage: 50,
          title: "Beta Testing",
          description: "Community testing phase",
          reached: true,
          reachedAt: new Date("2024-02-15"),
        },
        {
          id: "3",
          percentage: 75,
    ...
    backers: [
      ...
      },
      {
        ...
        investmentAmount: 50,
        investedAt: new Date("2024-02-05"),
      },
      {
        id: "3",
  ...
  },
  {
    ...
    description:
      "A metaverse gaming platform with play-to-earn mechanics and NFT integration.",
    logo: "🎮",
    ...
    timeline: {
      ...
      milestones: [
        ...
        },
        {
          ...
          percentage: 75,
          title: "Token Economy",
          description: "Play-to-earn implementation",
          reached: false,
        },
        {
          id: "4",
  ...
  },
  {
    ...
    description:
      "Blockchain-based carbon credit trading platform for sustainable businesses.",
    logo: "🌱",
      ...
      milestones: [
        {
          ...
          percentage: 25,
          title: "Platform Beta",
          description: "Initial trading platform",
          reached: true,
          reachedAt: new Date("2024-02-05"),
        },
        {
          id: "2",
          percentage: 50,
          title: "Corporate Partnerships",
          description: "B2B integrations",
          reached: false,
        },
        {
          id: "3",
          ...
          description: "Carbon credit verification",
          reached: false,
        },
        {
          id: "4",
    ...
    backers: [
      {
        id: "1",
        walletAddress: "0x6666666666666666666666666666666666666666" as Address,
        investmentAmount: 20,
        investedAt: new Date("2024-02-01"),
      },
      {
        id: "2",
        walletAddress: "0x7777777777777777777777777777777777777777" as Address,
        investmentAmount: 25.8,
        investedAt: new Date("2024-02-12"),
      },
    ],
    updates: [],
...
export default function ProjectsGrid() {
  ...
  const filteredProjects = useMemo(() => {
    ...
    if (filters.verified !== undefined) {
      result = result.filter(
        (project) => project.verification.verified === filters.verified
      );
    }
    ...
    if (filters.minFunding !== undefined) {
      result = result.filter(
        (project) => project.funding.currentAmount >= filters.minFunding!
      );
    }
    if (filters.maxFunding !== undefined) {
      result = result.filter(
        (project) => project.funding.currentAmount <= filters.maxFunding!
      );
    }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {selectedProject && (
        <InvestModal
          ...
          projectAddress={
            selectedProject.smartContractAddress ||
            selectedProject.funding.fundingAddress
          }
