...
const projectPlanSchema = z.string().regex(/^ipfs:\/\/.*/, 'Must be a valid IPFS URL')
const solidityCodeSchema = z.string().min(50, 'Smart contract code is required')
const ownFundingSchema = z.number().min(0.1, 'Minimum own funding is 0.1 ETH')
const targetFundingSchema = z.number().min(1, 'Minimum target funding is 1 ETH')
const addressSchema = z.string().regex(/^0x[a-fA-F0-9]{40}$/, 'Must be a valid Ethereum address')
...
const ProjectForm = () => {
  ...
  const skinInGamePercentage = formData.targetFunding > 0 ? Math.round((formData.ownFunding / formData.targetFunding) * 100) : 0
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      <div className="text-center pb-8 border-b border-gray-200">
        ...
        <div className="flex justify-center space-x-4">
          {['Documentation', 'Technical', 'Economics', 'Funding', 'Review'].map((label, index) => {
            const stepNumber = index + 1
            const status = stepNumber < currentStep ? 'completed' : stepNumber === currentStep ? 'active' : 'inactive'
        ...
        <div className="lg:col-span-2 space-y-8">
          <AnimatePresence mode="wait">
            ...
            {currentStep === 1 && (
              ...
              >
                <div>
                  <h2 className="text-xl font-semibold text-gray-900 mb-2">Project Documentation</h2>
                  <p className="text-sm text-gray-600 mb-6">Provide essential documents that establish trust and credibility</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-3">
                      {getValidationState('whitepaperUrl').status === 'validating' && (
                  ...
                  <div id="whitepaper-help" className="text-xs text-gray-500">
                    Upload your white paper to IPFS and paste the link here. We'll validate the document automatically.
                  </div>
                  
                  {getValidationState('whitepaperUrl').status === 'error' && (
                    <div id="whitepaper-error" className="flex items-center space-x-2 text-sm text-red-700">
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-medium text-green-900">White Paper Verified</p>
                          <p className="text-xs text-green-700">PDF • 2.4 MB • 24 pages</p>
                        </div>
                        <a href="#" className="text-sm text-green-600 hover:text-green-700 font-medium">Preview</a>
                      </div>
                    </motion.div>
                  )}
                </div>
                ...
                {/* Project Plan URL */}
                <div className="space-y-2">
                  <label htmlFor="project-plan-url" className="block text-sm font-medium text-gray-700">
                    Project Plan URL <span className="text-red-500">*</span>
                    <span className="block text-xs text-gray-500 font-normal">IPFS link to your detailed project roadmap</span>
                  </label>
                  <div className="relative">
                    <motion.input
                      type="url"
                      ...
                      onChange={(e) => handleInputChange('projectPlanUrl', e.target.value)}
                      className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg placeholder-gray-400 text-gray-900 text-base font-mono text-sm focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition-colors duration-200"
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-3">
                      {getValidationState('projectPlanUrl').status === 'validating' && (
                        <div className="animate-spin w-4 h-4 border-2 border-blue-600 border-t-transparent rounded-full" />
                      )}
                      {getValidationState('projectPlanUrl').status === 'valid' && (
                        <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                        </svg>
                      )}
            ...
            {currentStep === 2 && (
              ...
              >
                <div>
                  <h2 className="text-xl font-semibold text-gray-900 mb-2">Technical Implementation</h2>
                  <p className="text-sm text-gray-600 mb-6">Provide your smart contract code and technical specifications</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="border border-gray-300 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-blue-600 focus-within:border-blue-600">
                    ...
                    <div className="flex items-center justify-between p-3 bg-gray-50 border-b border-gray-200">
                      <div className="flex items-center space-x-3">
                        <span className="text-sm font-medium text-gray-700">contract.sol</span>
                        <div className="compilation-status">
                          <span className={`inline-flex items-center px-2 py-1 text-xs rounded-full ${
                            compilationStatus === 'success' ? 'bg-green-100 text-green-600' :
                            compilationStatus === 'compiling' ? 'bg-blue-100 text-blue-600' :
                            compilationStatus === 'error' ? 'bg-red-100 text-red-600' :
                            'bg-gray-100 text-gray-600'
                          }`}>
                            <div className={`w-2 h-2 rounded-full mr-1 ${
                              compilationStatus === 'success' ? 'bg-green-400' :
                              compilationStatus === 'compiling' ? 'bg-blue-400 animate-pulse' :
                              compilationStatus === 'error' ? 'bg-red-400' :
                              'bg-gray-400'
                            }`} />
    ...
    // Your smart contract code here
                      ...
                      <div className="absolute left-0 top-0 bottom-0 w-12 bg-gray-50 border-r border-gray-200 flex flex-col text-xs text-gray-500 font-mono pt-4">
                        {Array.from({ length: 20 }, (_, i) => (
                          <div key={i + 1} className="h-6 flex items-center justify-end pr-2">
                            {i + 1}
                          </div>
                        ))}
                      </div>
                    ...
                    <div className="flex items-center justify-between p-3 bg-gray-50 border-t border-gray-200">
                      <div className="flex items-center space-x-4 text-sm text-gray-600">
                        <span>Lines: {formData.smartContractCode.split('\n').length}</span>
                        <span>Characters: {formData.smartContractCode.length}</span>
                        <span>Solidity ^0.8.0</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <button type="button" className="px-3 py-1 text-xs font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded">
                          Format Code
                        </button>
                        <button type="button" className="px-3 py-1 text-xs font-medium text-purple-600 hover:text-purple-700 hover:bg-purple-50 rounded">
                          Security Audit
                        </button>
                      </div>
                    </div>
                  ...
                  {compilationStatus === 'success' && (
                    ...
                    >
                      <div className="flex items-center space-x-2 mb-2">
                        ...
                        <span className="text-sm font-medium text-green-900">Compilation Successful</span>
                      </div>
            ...
            {currentStep === 3 && (
              ...
              >
                <div>
                  <h2 className="text-xl font-semibold text-gray-900 mb-2">Economic Model</h2>
                  <p className="text-sm text-gray-600 mb-6">Define your tokenomics and economic structure</p>
                </div>
                
                {/* Tokenomics Visualization */}
                <div className="bg-gray-50 rounded-lg p-6">
                  <h3 className="text-sm font-medium text-gray-900 mb-4">Token Distribution</h3>
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-3">
                      <div className="flex items-center space-x-2">
                        <div className="w-4 h-4 bg-blue-500 rounded"></div>
                        <span className="text-sm text-gray-700">Public Sale (40%)</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <div className="w-4 h-4 bg-green-500 rounded"></div>
                        <span className="text-sm text-gray-700">Team (20%)</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <div className="w-4 h-4 bg-purple-500 rounded"></div>
                        <span className="text-sm text-gray-700">Development (25%)</span>
                      </div>
                    </div>
                    <div className="space-y-3">
                      <div className="flex items-center space-x-2">
                        <div className="w-4 h-4 bg-orange-500 rounded"></div>
                        <span className="text-sm text-gray-700">Marketing (10%)</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <div className="w-4 h-4 bg-red-500 rounded"></div>
                        <span className="text-sm text-gray-700">Reserve (5%)</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {currentStep === 4 && (
              ...
              >
                <div>
                  <h2 className="text-xl font-semibold text-gray-900 mb-2">Funding Structure</h2>
                  <p className="text-sm text-gray-600 mb-6">Set your funding goals and demonstrate commitment</p>
                </div>
                  ...
                  {formData.ownFunding > 0 && formData.targetFunding > 0 && (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-blue-700">Skin-in-game percentage:</span>
                        <span className="text-sm font-bold text-blue-900">{skinInGamePercentage}%</span>
                      </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h4 className="text-sm font-medium text-gray-900 mb-2">Market Context</h4>
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        <span className="text-gray-600">Similar projects avg:</span>
                        <span className="font-medium text-gray-900 ml-2">150 ETH</span>
                      </div>
                      <div>
                        <span className="text-gray-600">Success rate at this level:</span>
                        <span className="font-medium text-green-600 ml-2">78%</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
                    <div className="flex items-start space-x-2">
                      ...
                      <div className="text-sm">
                        <p className="font-medium text-amber-900 mb-1">Multi-signature Recommended</p>
                        <p className="text-amber-700">Consider using a multi-sig wallet for enhanced security and trust.</p>
            ...
            {currentStep === 5 && (
              ...
              >
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-6">Review your project before submission</p>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-gray-600">This is how your project will appear to investors</p>
                  </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            ...
            >
              <motion.div 
                className={`w-2 h-2 rounded-full ${autoSaveStatus === 'saving' ? 'bg-blue-400' : 'bg-green-400'}`}
                variants={{
            ...
            <p className="text-xs text-gray-500 mt-1">
              {lastAutoSave ? `Last saved ${Math.round((Date.now() - lastAutoSave.getTime()) / 60000)} minutes ago` : 'No changes to save'}
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            ...
            <div className="space-y-2">
              {['Documentation', 'Technical Details', 'Economics', 'Funding', 'Review'].map((step, index) => {
                const stepNumber = index + 1
          ...
          <div className="bg-blue-50 rounded-lg border border-blue-200 p-4">
            ...
            <div className="space-y-2">
              <a href="#" className="block text-xs text-blue-600 hover:text-blue-700 font-medium">
